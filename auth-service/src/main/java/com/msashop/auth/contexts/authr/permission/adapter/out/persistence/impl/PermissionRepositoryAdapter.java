package com.msashop.auth.contexts.authr.permission.adapter.out.persistence.impl;
...
import com.msashop.auth.contexts.authr.permission.adapter.out.persistence.mapper.PermissionEntityMapper;
import com.msashop.auth.contexts.authr.permission.adapter.out.persistence.repo.PermissionJpaRepository;
import com.msashop.auth.contexts.authr.permission.adapter.out.persistence.spec.PermissionEntitySpecifications;
import com.msashop.auth.contexts.authr.permission.domain.model.Permission;
import com.msashop.auth.contexts.authr.permission.domain.model.PermissionFilter;
import com.msashop.auth.contexts.authr.permission.domain.port.out.PermissionCommandPort;
import com.msashop.auth.contexts.authr.permission.domain.port.out.PermissionQueryPort;
