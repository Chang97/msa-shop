package com.msashop.auth.contexts.attachment.adapter.in.web.query.controller;
...
import com.msashop.auth.contexts.attachment.adapter.in.web.query.dto.AtchFileQueryRequest;
import com.msashop.auth.contexts.attachment.adapter.in.web.query.dto.AtchFileQueryResponse;
import com.msashop.auth.contexts.attachment.adapter.in.web.query.dto.AtchFileSummaryResponse;
import com.msashop.auth.contexts.attachment.adapter.in.web.query.mapper.AtchFileQueryWebMapper;
import com.msashop.auth.contexts.attachment.application.query.dto.AtchFileQuery;
import com.msashop.auth.contexts.attachment.application.query.port.in.GetAtchFileUseCase;
import com.msashop.auth.contexts.attachment.application.query.port.in.GetAtchFilesUseCase;
