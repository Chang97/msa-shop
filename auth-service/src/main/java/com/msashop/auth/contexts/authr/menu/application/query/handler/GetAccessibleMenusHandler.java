package com.msashop.auth.contexts.authr.menu.application.query.handler;
...
import com.msashop.auth.contexts.authr.menu.application.query.dto.MenuTreeResult;
import com.msashop.auth.contexts.authr.menu.application.query.dto.UserMenuAccessResult;
import com.msashop.auth.contexts.authr.menu.application.query.mapper.MenuQueryMapper;
...
import com.msashop.auth.contexts.authr.menu.domain.port.out.MenuQueryPort;
import com.msashop.auth.contexts.authr.menu.domain.service.MenuViewBuilder;
import com.msashop.auth.contexts.authr.menu.domain.view.MenuViews;
