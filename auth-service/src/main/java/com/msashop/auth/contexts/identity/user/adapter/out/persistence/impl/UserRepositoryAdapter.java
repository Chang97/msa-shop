package com.msashop.auth.contexts.identity.user.adapter.out.persistence.impl;
...
import com.msashop.auth.contexts.identity.user.adapter.out.persistence.entity.UserEntity;
import com.msashop.auth.contexts.identity.user.adapter.out.persistence.mapper.UserEntityMapper;
import com.msashop.auth.contexts.identity.user.adapter.out.persistence.repo.UserJpaRepository;
import com.msashop.auth.contexts.identity.user.adapter.out.persistence.spec.UserEntitySpecifications;
import com.msashop.auth.contexts.identity.user.domain.model.User;
import com.msashop.auth.contexts.identity.user.domain.model.UserFilter;
