package com.msashop.auth.contexts.authr.permission.adapter.in.web.command.controller;
...
import com.msashop.auth.contexts.authr.permission.adapter.in.web.command.dto.PermissionCommandRequest;
import com.msashop.auth.contexts.authr.permission.adapter.in.web.command.dto.PermissionCommandResponse;
import com.msashop.auth.contexts.authr.permission.adapter.in.web.command.mapper.PermissionCommandWebMapper;
import com.msashop.auth.contexts.authr.permission.application.command.dto.PermissionCommandResult;
import com.msashop.auth.contexts.authr.permission.application.command.port.in.CreatePermissionUseCase;
import com.msashop.auth.contexts.authr.permission.application.command.port.in.DeletePermissionUseCase;
import com.msashop.auth.contexts.authr.permission.application.command.port.in.UpdatePermissionUseCase;
