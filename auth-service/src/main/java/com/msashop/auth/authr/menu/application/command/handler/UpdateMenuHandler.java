package com.msashop.auth.authr.menu.application.command.handler;
...
import com.msashop.auth.authr.menu.application.command.mapper.MenuCommandMapper;
import com.msashop.auth.authr.menu.application.command.port.in.UpdateMenuUseCase;
import com.msashop.auth.authr.menu.application.command.support.MenuPermissionSynchronizer;
import com.msashop.auth.authr.menu.domain.model.Menu;
import com.msashop.auth.authr.menu.domain.model.MenuId;
import com.msashop.auth.authr.menu.domain.policy.MenuPolicy;
