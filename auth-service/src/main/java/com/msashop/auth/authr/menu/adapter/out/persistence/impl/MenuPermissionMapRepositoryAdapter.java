package com.msashop.auth.authr.menu.adapter.out.persistence.impl;
...
import com.msashop.auth.authr.menu.adapter.out.persistence.entity.MenuEntity;
import com.msashop.auth.authr.menu.adapter.out.persistence.entity.MenuPermissionMapEntity;
import com.msashop.auth.authr.menu.adapter.out.persistence.mapper.MenuPermissionMapEntityMapper;
import com.msashop.auth.authr.menu.adapter.out.persistence.repo.MenuJpaRepository;
import com.msashop.auth.authr.menu.adapter.out.persistence.repo.MenuPermissionMapJpaRepository;
import com.msashop.auth.authr.menu.domain.model.MenuPermissionMap;
import com.msashop.auth.authr.menu.domain.port.out.MenuPermissionMapCommandPort;
import com.msashop.auth.authr.menu.domain.port.out.MenuPermissionMapQueryPort;
import com.msashop.auth.authr.permission.adapter.out.persistence.repo.PermissionJpaRepository;
