...
import com.msashop.auth.identity.user.application.command.mapper.UserCommandMapper;
...
import com.msashop.auth.identity.user.domain.port.out.UserRoleAssignmentPort;
