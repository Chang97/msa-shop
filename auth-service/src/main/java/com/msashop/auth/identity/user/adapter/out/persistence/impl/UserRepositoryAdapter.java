package com.msashop.auth.identity.user.adapter.out.persistence.impl;
...
import com.msashop.auth.identity.user.adapter.out.persistence.mapper.UserEntityMapper;
import com.msashop.auth.identity.user.adapter.out.persistence.repo.UserJpaRepository;
import com.msashop.auth.identity.user.adapter.out.persistence.spec.UserEntitySpecifications;
import com.msashop.auth.identity.user.domain.model.User;
import com.msashop.auth.identity.user.domain.model.UserFilter;
import com.msashop.auth.identity.user.domain.port.out.UserCommandPort;
import com.msashop.auth.identity.user.domain.port.out.UserQueryPort;
