package com.msashop.auth.identity.auth.application;
...
import com.msashop.auth.authr.cache.domain.port.out.AuthorityCachePort;
import com.msashop.auth.authr.permission.application.query.service.PermissionCatalogService;
