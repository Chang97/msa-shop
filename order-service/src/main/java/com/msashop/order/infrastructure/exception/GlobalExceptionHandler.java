...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({ProductUnavailableException.class, ProductPriceMismatchException.class})
    public ResponseEntity<Map<String, Object>> handleProductConflicts(RuntimeException ex) {
